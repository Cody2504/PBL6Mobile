          ...
          <View style={styles.header}>
            ...
            >
              {isSubmitting ? (
                ...
                <Text style={[styles.saveText, !teamName.trim() && styles.saveTextDisabled]}>
                  Save
                </Text>
              )}
            </TouchableOpacity>
          ...
          <View style={styles.inputContainer}>
            ...
            <View style={styles.inputSection}>
              <View style={styles.codeHeader}>
                ...
                <TouchableOpacity onPress={handleRegenerateClassCode} disabled={isSubmitting}>
                  <Text style={[styles.regenerateLink, isSubmitting && styles.regenerateLinkDisabled]}>
                    Regenerate
                  </Text>
                </TouchableOpacity>
              </View>
              ...
              <Text style={styles.codeHelpText}>Share this code with students to join the team</Text>
            </View>
          </View>
        </Animated.View>
      </KeyboardAvoidingView>
