...
import { View, Text, TextInput, Pressable, StyleSheet, Modal, Alert, ActivityIndicator } from 'react-native';
...
const JoinTeamModal: React.FC<JoinTeamModalProps> = ({
  ...
  const handleJoin = async () => {
    ...
    try {
      ...
      const errorMessage = error.message || 'Failed to join team. Please check the code and try again.';
