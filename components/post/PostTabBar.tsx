...
const PostTabBar: React.FC<PostTabBarProps> = ({ activeTab, onTabChange }) => {
  return (
    <View style={styles.tabBar}>
      <TouchableOpacity 
        style={activeTab === 'posts' ? styles.activeTabContainer : styles.tabContainer}
        activeOpacity={1}
      ...
      <TouchableOpacity
        style={activeTab === 'files' ? styles.activeTabContainer : styles.tabContainer}
        activeOpacity={1}
        onPress={() => onTabChange('files')}
      >
        <Text style={activeTab === 'files' ? styles.activeTabText : styles.tabText}>
          Tệp
        </Text>
      ...
      <TouchableOpacity
        style={activeTab === 'other' ? styles.activeTabContainer : styles.tabContainer}
        activeOpacity={1}
        onPress={() => onTabChange('other')}
      >
        <Text style={activeTab === 'other' ? styles.activeTabText : styles.tabText}>
          Khác
        </Text>
