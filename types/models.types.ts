...
export type MaterialType = 'document' | 'image' | 'video' | 'audio' | 'pdf' | 'spreadsheet' | 'presentation' | 'archive' | 'other';
...
export type ActivityType = 'post' | 'assignment' | 'comment' | 'material' | 'grade';
...
export type NotificationType = 'message' | 'assignment' | 'grade' | 'announcement' | 'system';
